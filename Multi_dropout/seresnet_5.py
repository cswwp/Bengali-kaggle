...
class se_resnext50_32x4d_bengali(nn.Module):
    def __init__(self, base):
        ...
        # Final linear layer
        self._dropout_1 = nn.Dropout(0.2)
        self._dropout_2 = nn.Dropout(0.2)
        self._dropout_3 = nn.Dropout(0.2)
        self._dropout_4 = nn.Dropout(0.2)
        self._dropout_5 = nn.Dropout(0.2)
    ...
    def forward(self, inputs):
        ...
        x =   (  self.liner(self._dropout_1(x)) + \
                self.liner(self._dropout_2(x)) + \
                self.liner(self._dropout_3(x)) + \
                self.liner(self._dropout_4(x)) + \
                self.liner(self._dropout_5(x)) 
                ) /5
