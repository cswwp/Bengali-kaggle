...
class ResNet(nn.Module):
    def __init__(self, builder:ConvBuilder, block, num_blocks, num_classes=10):
        ...
        self.linear1 = self.bd.Linear(512*block.expansion, 11)
        self.linear2 = self.bd.Linear(512 * block.expansion, 168)
        self.linear3 = self.bd.Linear(512 * block.expansion, 7)
...
if __name__ == '__main__':
    ...
    res18 = create_ResNet18(None, builder)
    stat(res18, (3, 128, 128))

    import torch
    img = torch.rand([1,3, 224, 224])
    out1, out2, out3 = res18(img)
    print('out:', out1.shape, out2.shape, out3.shape)
